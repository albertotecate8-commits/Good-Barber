...
export function friendlyError(error) {
  ...
  if (msg.includes("semana ya cerrada")) {
    return "Esta semana ya está cerrada y no puedes modificar este registro. Solicita al administrador que realice el cambio.";
  }
  if (error?.code === "DUPLICATE_PHONE" || (error?.code === "23505" && msg.includes("phone_normalized"))) {
